 ...
 * Allows user to input numbers, operators, evaluate expressions,
 * clear input, and delete last character. Maintains result state.
 * Renders number pad and operations. Calculates result
 * on evaluate.
 */
const App = () => {
    ...
    <>
      <div className="container">
        ...
        <div className="keypad">
          <button className="highlight" id="Clean" onClick={clear}>
            Clear
          </button>
